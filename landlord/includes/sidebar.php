<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="manage-students.php"><i class="fa fa-file"></i>Hostellers</a></li>
				<li><a href="create-room.php"><i class='fa fa-cloud-upload'></i>Add Hostel</a></li>
				<li><a href="manage-rooms.php"><i class='fa fa-file'></i>Manage Hostels</a> </li>
