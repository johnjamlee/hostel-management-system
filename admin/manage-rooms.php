				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<button  class="btn-primary"> <a href="filter-students.php"  style="color: #fff; display:flex; float:right">Click here to filter Hostel data</a></button>
							</div>
...
<div class="col-sm-6 col-sm-offset-4">
 <button  class="btn-primary"> <a href="filter-students.php"  style="color: #fff">Click here to filter Hostel data</a></button>
