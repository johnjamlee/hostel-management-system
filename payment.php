...
if(isset($_POST['submit'])){
    ...
    $Account_no = 'Hostel Management'; // Enter account number optional
    ...
    $headers = array(
        ...
        'ApiKey: LFhvNDxrHyX' // Replace with your api key
     );
    ...
    if ($msg_resp ->success == 'true') {
        echo '<div class="center">Wait for Mpesa STK Popup to Complete Payment.</div>';
      } else {
